...
using MijiaScanner.Droid.TemplateSelectors;
...
namespace MijiaScanner.Droid
{
    ...
    public class LinkerPleaseInclude
    {
        ...
        public void Include(MvxRecyclerView recyclerView)
        {
            recyclerView = new MvxRecyclerView(new Activity(), null);
            recyclerView.Adapter = new MvxRecyclerAdapter();
            recyclerView.ItemClick = new MvxCommand(() => { });
            recyclerView.ItemLongClick = new MvxCommand(() => { });
            recyclerView.ItemsSource = new List<object>();
            recyclerView.ItemTemplateSelector = new DeviceTemplateSelector();
        }
    }
}